...
\begin{figure}[h!]
  ...
  \caption{La \textit{distancia} del nodo 1 al 5 es igual a 3. Nótese que están unidos por más de un camino y que se tuvo en cuenta el más breve de estos, $1 \rightarrow 4 \rightarrow 7 \rightarrow 5$.}
  \label{distancia}
\end{figure}
...
La red desagregada se visualiza como una ``red social'' de empresas. Cada empresa agrupa actividades industriales (tal cual figuran en su inscripción en la AFIP), como en la figura \ref{perfil}. Nótese que en general las actividades y las relaciones ahora se repiten, debido a las empresas que se dedican a las mismas tareas. Las actividades producen y consumen productos. Dos empresas tendrán una relación si la actividad de una produce un producto que la actividad de la otra consume—una manera larga de decir que dos empresas tienen una relación comercial.
